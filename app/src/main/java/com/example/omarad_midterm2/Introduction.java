    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        act2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(Introduction.this,DataBaseAccess.class));
            }
        });
        act3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(Introduction.this,DataBaseAccess2.class));
            }
        });
        ...
        final DatePickerDialog.OnDateSetListener d= new DatePickerDialog.OnDateSetListener(){
            ...
            public void onDateSet(DatePicker datePicker, int year, int month, int day) {
                ...
                showToastMessage("You've Chosen: " +df.format(c.getTime()),5000);
            }
        };
        pickDate.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                new DatePickerDialog(Introduction.this,d,
                        c.get(Calendar.YEAR),
